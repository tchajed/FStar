           ...
           (fun k  ->
              ...
              FStar_List.map
                (fun f  ->
                   ...
                   (f, deps_as_filenames)) as_list) _0_876
          in
       let topologically_sorted =
         let _0_877 = FStar_ST.read topologically_sorted  in
         FStar_List.collect must_find_r _0_877  in
       FStar_List.iter
         (fun uu____1404  ->
                       ...
                       | true  ->
                           let _0_879 =
                             FStar_String.substring m (Prims.parse_int "0")
                               (k - (Prims.parse_int "4"))
                              in
                           FStar_Util.format1 " Did you mean %s ?" _0_879
                       | uu____1428 -> ""  in
                     Prims.raise
                       (FStar_Errors.Err
                          (FStar_Util.format3
