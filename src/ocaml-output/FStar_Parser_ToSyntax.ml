...
let _66_974 = env
in {FStar_Parser_Env.curmodule = _66_974.FStar_Parser_Env.curmodule; FStar_Parser_Env.curmonad = _66_974.FStar_Parser_Env.curmonad; FStar_Parser_Env.modules = _66_974.FStar_Parser_Env.modules; FStar_Parser_Env.scope_mods = _66_974.FStar_Parser_Env.scope_mods; FStar_Parser_Env.exported_ids = _66_974.FStar_Parser_Env.exported_ids; FStar_Parser_Env.trans_exported_ids = _66_974.FStar_Parser_Env.trans_exported_ids; FStar_Parser_Env.includes = _66_974.FStar_Parser_Env.includes; FStar_Parser_Env.sigaccum = _66_974.FStar_Parser_Env.sigaccum; FStar_Parser_Env.sigmap = _66_974.FStar_Parser_Env.sigmap; FStar_Parser_Env.default_result_effect = _66_974.FStar_Parser_Env.default_result_effect; FStar_Parser_Env.iface = _66_974.FStar_Parser_Env.iface; FStar_Parser_Env.admitted_iface = _66_974.FStar_Parser_Env.admitted_iface; FStar_Parser_Env.expect_typ = false})
...
let tcs = (FStar_List.map (fun _66_2931 -> (match (_66_2931) with
| (x, _66_2930) -> begin
x
end)) tcs)
...
| FStar_Syntax_Syntax.Tm_let (lbs, _66_2940) -> begin
(
...
| (_66_2948)::_66_2946 -> begin
(FStar_List.map (trans_qual None) quals)
end
| _66_2951 -> begin
(FStar_All.pipe_right (Prims.snd lbs) (FStar_List.collect (fun _66_28 -> (match (_66_28) with
| {FStar_Syntax_Syntax.lbname = FStar_Util.Inl (_66_2962); FStar_Syntax_Syntax.lbunivs = _66_2960; FStar_Syntax_Syntax.lbtyp = _66_2958; FStar_Syntax_Syntax.lbeff = _66_2956; FStar_Syntax_Syntax.lbdef = _66_2954} -> begin
[]
end
| {FStar_Syntax_Syntax.lbname = FStar_Util.Inr (fv); FStar_Syntax_Syntax.lbunivs = _66_2972; FStar_Syntax_Syntax.lbtyp = _66_2970; FStar_Syntax_Syntax.lbeff = _66_2968; FStar_Syntax_Syntax.lbdef = _66_2966} -> begin
(FStar_Parser_Env.lookup_letbinding_quals env fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
end))))
end)
in (

let quals = if (FStar_All.pipe_right lets (FStar_Util.for_some (fun _66_2980 -> (match (_66_2980) with
| (_66_2978, t) -> begin
...
let _66_2986 = fv
in {FStar_Syntax_Syntax.fv_name = _66_2986.FStar_Syntax_Syntax.fv_name; FStar_Syntax_Syntax.fv_delta = FStar_Syntax_Syntax.Delta_abstract (fv.FStar_Syntax_Syntax.fv_delta); FStar_Syntax_Syntax.fv_qual = _66_2986.FStar_Syntax_Syntax.fv_qual})); FStar_Syntax_Syntax.lbunivs = _66_2984.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _66_2984.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = _66_2984.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = _66_2984.FStar_Syntax_Syntax.lbdef})))))
...
let _66_3020 = (FStar_Parser_Env.fail_or env (FStar_Parser_Env.try_lookup_lid env) FStar_Syntax_Const.exn_lid)
in (match (_66_3020) with
| (t, _66_3019) -> begin
(
...
let _66_3049 = (desugar_binders env binders)
in (match (_66_3049) with
| (env_k, binders) -> begin
(
...
let _66_3113 = (match (l.FStar_Parser_AST.lift_op) with
...
let desugar_decls : FStar_Parser_Env.env  ->  FStar_Parser_AST.decl Prims.list  ->  (FStar_Parser_Env.env * FStar_Syntax_Syntax.sigelts) = (fun env decls -> (FStar_List.fold_left (fun _66_3119 d -> (match (_66_3119) with
| (env, sigelts) -> begin
(

let _66_3123 = (desugar_decl env d)
in (match (_66_3123) with
| (env, se) -> begin
...
let _66_3149 = (desugar_decls env decls)
in (match (_66_3149) with
| (env, sigelts) -> begin
(
...
| FStar_Parser_AST.Interface (mname, _66_3160, _66_3162) -> begin
...
let _66_3170 = (desugar_modul_common curmod env m)
in (match (_66_3170) with
| (x, y, _66_3169) -> begin
((x), (y))
end))))
...
let _66_3176 = (desugar_modul_common None env m)
in (match (_66_3176) with
...
let _66_3178 = if (FStar_Options.dump_module modul.FStar_Syntax_Syntax.name.FStar_Ident.str) then begin
...
let _66_3191 = (FStar_List.fold_left (fun _66_3184 m -> (match (_66_3184) with
| (env, mods) -> begin
(

let _66_3188 = (desugar_modul env m)
in (match (_66_3188) with
| (env, m) -> begin
((env), ((m)::mods))
end))
end)) ((env), ([])) f)
in (match (_66_3191) with
| (env, mods) -> begin
...
let _66_3196 = (FStar_Parser_Env.prepare_module_or_interface false false en m.FStar_Syntax_Syntax.name)
in (match (_66_3196) with
...
let _66_3197 = en
in {FStar_Parser_Env.curmodule = Some (m.FStar_Syntax_Syntax.name); FStar_Parser_Env.curmonad = _66_3197.FStar_Parser_Env.curmonad; FStar_Parser_Env.modules = _66_3197.FStar_Parser_Env.modules; FStar_Parser_Env.scope_mods = _66_3197.FStar_Parser_Env.scope_mods; FStar_Parser_Env.exported_ids = _66_3197.FStar_Parser_Env.exported_ids; FStar_Parser_Env.trans_exported_ids = _66_3197.FStar_Parser_Env.trans_exported_ids; FStar_Parser_Env.includes = _66_3197.FStar_Parser_Env.includes; FStar_Parser_Env.sigaccum = _66_3197.FStar_Parser_Env.sigaccum; FStar_Parser_Env.sigmap = _66_3197.FStar_Parser_Env.sigmap; FStar_Parser_Env.default_result_effect = _66_3197.FStar_Parser_Env.default_result_effect; FStar_Parser_Env.iface = _66_3197.FStar_Parser_Env.iface; FStar_Parser_Env.admitted_iface = _66_3197.FStar_Parser_Env.admitted_iface; FStar_Parser_Env.expect_typ = _66_3197.FStar_Parser_Env.expect_typ}) m.FStar_Syntax_Syntax.exports)
in (
